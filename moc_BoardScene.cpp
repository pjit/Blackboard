...
static const char qt_meta_stringdata_BoardScene[] = {
    "BoardScene\0"
};
...
const QMetaObjectExtraData BoardScene::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BoardScene::staticMetaObject = {
    { &Board::staticMetaObject, qt_meta_stringdata_BoardScene,
      qt_meta_data_BoardScene, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BoardScene::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BoardScene))
